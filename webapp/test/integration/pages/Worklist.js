					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success: function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("GuaranteedateInternalid"),
								name: oBindingContext.getProperty("GuaranteeDate")
							};
						}
					}));
				},
						...
						success: function (oTable) {
							return this.waitFor({
								...
								success: function (aItems) {
									var aAllEntities = this.getEntitySet("ZC_SD_GuaranteeDates_Maint_Rep");
