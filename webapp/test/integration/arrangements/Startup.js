sap.ui.define([
	"sap/ui/test/Opa5",
	"com/nttdata/acumed/Z27CheckInCheckOut/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.nttdata.acumed.Z27CheckInCheckOut.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.nttdata.acumed.Z27CheckInCheckOut",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ZC_SD_GuaranteeDates_Maint_Rep/" + sObjectId;
