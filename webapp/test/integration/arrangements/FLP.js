...
sap.ui.define([
	...
	"com/nttdata/acumed/Z27CheckInCheckOut/test/flpSandbox"
	...
	return Opa5.extend("com.nttdata.acumed.Z27CheckInCheckOut.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ZC_SD_GuaranteeDates_Maint_Rep/" + encodeURIComponent(sObjectId);
