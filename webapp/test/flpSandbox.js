						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#CheckInCheckOut-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"CheckInCheckOut-display": {
								"semanticObject": "CheckInCheckOut",
								"action": "display",
								"description": "Check In - Check Out for Production Orders",
								"title": "Check In - Check Out",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nttdata.acumed.Z27CheckInCheckOut",
									"url": sap.ui.require.toUrl("com/nttdata/acumed/Z27CheckInCheckOut")
								}
							}
						}
					}
